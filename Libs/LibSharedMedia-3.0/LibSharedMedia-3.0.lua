...
lib.MediaTable.background["Blizzard Garrison Background 3"] =
...
function lib:Register(mediatype, key, data, langmask)
	...
	if
		type(data) == "string"
		and (
			mediatype == lib.MediaType.BACKGROUND
			or mediatype == lib.MediaType.BORDER
			or mediatype == lib.MediaType.STATUSBAR
			or mediatype == lib.MediaType.SOUND
		)
	then
