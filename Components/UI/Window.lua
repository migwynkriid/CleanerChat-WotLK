...
local function CreateWindow(opts)
	...
	window.moverFrame =
		Core.Components.CreateMoverFrame(opts.moverName or ("GlassMoverFrame" .. id), parent, window.profile)
	...
	window.container =
		Core.Components.CreateMainContainerFrame(opts.containerName or ("GlassFrame" .. id), parent, window.profile)
	...
	-- correct dock.
	window.dock =
		Core.Components.CreateChatDock(window.container, opts.dockName or ("GlassChatDock" .. id), window.profile)
