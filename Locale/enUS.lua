...
L["Bubbles"] = true
L["Activate bubbles"] = true
L["Strip the default black background from SAY and YELL chat bubbles (the speech balloons shown over a player's or NPC's head), leaving only the message text."] = true
L["Display speaker name"] = true
L["Show the speaker's name in front of the bubble text, class-coloured for players (e.g. \"Playername: Hello\")."] = true
L["Font used for the chat bubble text. Defaults to your chat message font."] = true
L["Outline style for the chat bubble text. Defaults to your chat message outline."] = true
L["Custom fade delay"] = true
L["Override the game's default chat bubble fade time with your own duration."] = true
L["Message duration"] = true
L["How long a chat bubble stays on screen before fading out, in seconds."] = true
...
L["Restore chat on reload"] = true
L["Restores recent chat messages after a UI reload."] = true
L["Animations"] = true
