...
L["Copy Chat History"] = true
L["Enable the /copychat command and window for copying chat history."] = true
L["Keyword Highlighting"] = true
L["Highlight your name in chat with a colour and an alert sound."] = true
L["Keyword Highlighting Sound"] = true
L["Play an alert sound when your name is highlighted in chat. Requires Keyword Highlighting."] = true
L["Shift-Click Invite"] = true
L["Shift-click a player name in chat to send a group invite."] = true
