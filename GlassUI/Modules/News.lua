...
-- Note: AceGUI removed for WotLK backport compatibility
...
function News:OnEnable()
  -- WotLK 3.3.5 backport: AceGUI Frame widgets have compatibility issues
  -- with Ascension's BackdropTemplate system. Disable the news popup
  -- and just print to chat instead.
  
  Core:Subscribe(OPEN_NEWS, function ()
    -- Simple fallback: print changelog to chat
    print("|c00DFBA69Glass|r: Version " .. Core.Version)
    print("|c00DFBA69Glass|r: Check CHANGELOG.md for version history")
  end)
end
