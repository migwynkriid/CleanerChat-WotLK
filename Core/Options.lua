...
local filterDB = {
	...
	linkHover = {
		name = L["Link Hover Tooltips"],
		desc = L["Show item, spell, quest, and achievement tooltips when hovering chat links."],
		width = 1.5,
		type = "toggle",
		set = setter,
		get = getter,
	...
	urlCopy = {
		name = L["URL Detection & Copy"],
		desc = L["Make web links in chat clickable and open a copy dialog."],
		width = 1.5,
		type = "toggle",
		set = setter,
		get = getter,
	...
	copyChat = {
		...
		desc = L["Enable /copychat command and window for copying chat history."],
		width = 1.5,
		type = "toggle",
		set = setter,
		get = getter,
	...
	altNames = {
		name = L["Alt Name Tagging"],
		desc = L["Parse guild notes to display Main character names next to Alts."],
		width = 1.5,
		type = "toggle",
		set = setter,
		get = getter,
	...
	highlight = {
		...
		desc = L["Highlight player name and custom keywords with audio alerts."],
		width = 1.5,
		type = "toggle",
		set = setter,
		get = getter,
	...
	clickInvite = {
		...
		desc = L["Shift-click player names in chat to quickly send party invitations."],
		width = 1.5,
		type = "toggle",
		set = setter,
		get = getter,
