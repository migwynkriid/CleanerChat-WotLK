...
-- fn(accumulator, value) -> newAccumulator
ns.reduce = function(tbl, fn, initial)
	local acc = initial
...
-- Remove elements from array where predicate returns true (in-place).
ns.removeWhere = function(tbl, predicate)
	for i = #tbl, 1, -1 do
